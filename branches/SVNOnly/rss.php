...
if ($maxmessages > count($history->entries))
...
for ($n = 0; $n < $maxmessages; $n++)
{
   ...
   $item->description = $divbox.$divfont."${lang["REV"]} ".$r->rev." - ".$r->author." </span> ($files ${lang["FILESMODIFIED"]})</div><p>".nl2br(create_anchors($desc))."</p>";
   $item->date = ".$r->date.";
